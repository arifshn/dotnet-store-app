...
namespace API.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<Order>> CreateOrder(CreateOrderDTO orderDTO)
        {
            ...
            .Where(i => i.CustomerId == User.Identity!.Name)
            .FirstOrDefaultAsync();
            if (cart == null) return BadRequest(new ProblemDetails { Title = "cart alma aşamasında bir hata oldu" });
            ...
            return BadRequest(new ProblemDetails { Title = "cart alma aşamasında bir hata oldu" });
        }
    }
}